...
![Authorization Scene](CryptoWallet/Resources/Screenshots/AuthorizationScene.png)

![Loading Scene](CryptoWallet/Resources/Screenshots/LoadingScene.png)

![Home Scene](CryptoWallet/Resources/Screenshots/HomeScene.png)

![Details Scene](CryptoWallet/Resources/Screenshots/DetailsScene.png)

## Элементы интерфейса

- **More Button:**

![More Button](CryptoWallet/Resources/Screenshots/MoreButton.png)

- **Segmenter and Back Button:**

![Segmenter and Back Button](CryptoWallet/Resources/Screenshots/SegmenterAndBackButton.png)

- **Filter Button:**

![Filter Button](CryptoWallet/Resources/Screenshots/FilterButton.png)

- **TabBar:**

![TabBar](CryptoWallet/Resources/Screenshots/TabBar.png)

- **TextField:**

![TextField](CryptoWallet/Resources/Screenshots/TextField.png)
