...
CryptoWallet — это iOS-приложение, которое может быть использовано как полноценный крипто-кошелёк. 
...
<table>
  ...
  <tr>
    ...
    <tr>
    <td align="center">
      <img src="CryptoWallet/Resources/Screenshots/BadLoginOrPasswordAlert.png" alt="TextField" width="300"/><br>
      <b>Login Alert</b>
    </td>
    <td align="center">
      <img src="CryptoWallet/Resources/Screenshots/BadURLSessionAlert.png" alt="TextField" width="300"/><br>
      <b>Error Alert</b>
    </td>
  </tr>
</table>
...
- **Архитектура:** MVVM (Model-View-ViewModel)  
  - Именно такой подход был выбран для разделения бизнес-логики, работы с данными и отображения информации.
  - Облегчает тестирование, поддержку и расширение проекта.
- **UI:**  
...
- **Сетевой слой:**  
  ...
  - Гибкий, универсальный и переиспользуемый.
  - Решен кейс с обработкой и выводом ошибок.
- **Хранение состояния:**  
...
- **Обработка ошибок с точки зрения UI:**  
  - Для неверного логина/пароля показывается UIAlertController с двумя вариантами действий.
  - При ошибке во время запроса предусматривается UIAlertController с предложением обновить страницу.
