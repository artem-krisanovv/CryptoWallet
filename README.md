...
![Authorization Scene](Screenshots/AuthorizationScene)

![Loading Scene](Screenshots/LoadingScene)

![Home Scene](Screenshots/HomeScene)

![Details Scene](Screenshots/DetailsScene)

## Элементы интерфейса

- **More Button:**

![More Button](Screenshots/MoreButton)

- **Segmenter and Back Button:**

![Segmenter and Back Button](Screenshots/SegmenterAndBackButton)

- **Filter Button:**

![Filter Button](Screenshots/FilterButton)

- **TabBar:**

![TabBar](Screenshots/Desktop/TabBar)

- **TextField:**

![TextField](Screenshots/Desktop/TextField)
