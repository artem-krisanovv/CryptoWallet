...
![Authorization Scene](Screenshots/Authorization Scene.png)

![Loading Scene](Screenshots/Loading Scene.png)

![Home Scene](Screenshots/Home Scene.png)

![Details Scene](Screenshots/Details Scene.png)

## Элементы интерфейса

- **More Button:**

![More Button](Screenshots/More Button.png)

- **Segmenter and Back Button:**

![Segmenter and Back Button](Screenshots/Segmenter and Back Button.png)

- **Filter Button:**

![Filter Button](Screenshots/Filter Button.png)

- **TabBar:**

![TabBar](Screenshots/Desktop/TabBar.png)

- **TextField:**

![TextField](Screenshots/Desktop/TextField.png)
